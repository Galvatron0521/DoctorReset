...
import com.shenkangyun.doctor.BeanFolder.EditConBean;
...
public class EditTreatAdapter extends BaseQuickAdapter<EditTreatBean.DataBean.FieldListBean.ChildListBeanX, BaseViewHolder> {


    public EditTreatAdapter() {
        super(R.layout.item_treat_add, null);
    }

    @Override
    protected void convert(BaseViewHolder helper, EditTreatBean.DataBean.FieldListBean.ChildListBeanX item) {
