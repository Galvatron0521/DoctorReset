...
public class ConstitutionActivity extends AppCompatActivity {
    ...
    private ConstitutionListAdapter constitutionListAdapter;
    ...
    public void onViewClicked() {
        Intent intent = new Intent(this, AddConstitutionActivity.class);
    ...
    private void initAdapter() {
        constitutionListAdapter = new ConstitutionListAdapter();
        layoutManager = new LinearLayoutManager(this);
        expendList.setLayoutManager(layoutManager);
        expendList.setAdapter(constitutionListAdapter);
        constitutionListAdapter.setNewData(tableEntities);
        //设置分组的监听
        constitutionListAdapter.setOnItemChildClickListener(new BaseQuickAdapter.OnItemChildClickListener() {
            @Override
            public void onItemChildClick(BaseQuickAdapter adapter, View view, int position) {
                int fieldRecordID = ((ConstitutionListAdapter) adapter).getItem(position).getFieldRecordID();
                Intent intent = new Intent(ConstitutionActivity.this, EditConstitutionActivity.class);
                intent.putExtra("moduleCode", moduleCode);
                intent.putExtra("moduleName", moduleName);
                intent.putExtra("patientID", patientID);
